...
if __name__ == "__main__":
    ...
    c = Hotkey_Handler()
    #c.add_hotkey(mouse.Button.x1, keyboard.Key.f15, type=MK)
    #c.add_hotkey(mouse.Button.x2, keyboard.KeyCode(char="a"), press_type=MK)
    #c.add_hotkey(mouse.Button.x1, mouse.Button.x2, press_type=MM)
    #c.add_hotkey(mouse.Button.x2, helloWorld, press_type=MF)
    #c.add_hotkey(keyboard.Key.enter, mouse.Button.x1, press_type=KM)
    #c.add_hotkey(keyboard.Key.shift, keyboard.Key.f15, press_type=KK)
    #c.add_hotkey(keyboard.Key.esc, printData, press_type=KF)
